...
let three = '<p class="item1" style="font-size:calc(15px + 0.5vw);margin-top: 30px;">This is your three-card spread. The cards from left to right represent the past, present, and future.</p><p class="item2" style="font-size:calc(15px + 0.5vw);">Click on each card to know its meaning.</p>';

let five = '<p class="item1" style="font-size:calc(15px + 0.5vw);margin-top: 30px;">This is your five-card spread. The cards from left to right represent the past, recent past, present, near future, and future.</p><p class="item2" style="font-size:calc(15px + 0.5vw);">Click on each card to know its meaning.</p>';
