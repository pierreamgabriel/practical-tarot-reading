...
let five = '<p class="item1" style="font-size:calc(15px + 0.5vw);margin-top: 30px;">This is your five cards spread containing the answers to your question. The cards one to five from left to right represent the past, recent past, present, near future, and future, respectively.</p><p class="item2" style="font-size:calc(15px + 0.5vw);">Click on each card to know their meaning.</p>';
    ...
    for (let i = 0; i < 22; i++) {
        let text = '<div class="modal fade" id="' + data[i]['id'] + '12" tabindex="-1" role="dialog" aria-labelledby="warningModalCenterTitle" aria-hidden="true"><div class="modal-dialog modal-dialog-centered" role="document"><div class="modal-content" style="font-family: "Stylish", sans-serif;"><div class="modal-header"><h5 class="modal-title" style="color:#000000;" id="warningModalLongTitle">' + data[i]['name'] + '</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="hideModal()"><span aria-hidden="true">&times;</span></button></div><div class="modal-body" style="text-align:justify;font-size:calc(12px + 0.5vw);color: #000000;">' + data[i]['meaning'] + '<div style="text-align:right;font-size:calc(12px + 0.5vw);color: #000000;margin: 0px 10px 10px 0px">Source: biddytarot.com</div></div></div></div></div>';
